...
function renderPhoneHandoff(report) {
  ...
  const lines = [
    ...
    "",
    "This file is generated by `npm run proof:prepare` / `npm run proof:doctor` from the current proof report.",
    "",
    "## Current Proof State",
    "",
    `- status: \`${status}\``,
    ...
    "## Phone Run",
    "",
    "1. Install the IPA on the iPhone with Sideloadly or AltStore.",
    "",
    "```text",
    report.artifacts?.ipa_path ?? "artifacts/unsigned-ipa/LiquidGlassCapture-unsigned.ipa",
    "```",
    "",
    "2. Open **Liquid Glass Capture** on the iPhone and press `B`.",
    "",
